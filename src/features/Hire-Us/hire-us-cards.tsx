...
const tabs = [
    {
        ...
        value: 'Hire Designer',
        cardsData: [
            { title: 'User Researcher', iconPath: '/hire-us/user-research.svg', link: '#' },
            { title: 'UX Designer', iconPath: '/hire-us/ux-designer.svg', link: '#' },
            { title: 'UI Designer', iconPath: '/hire-us/ui-designer.svg', link: '#' },
            { title: 'Interaction Designer', iconPath: '/hire-us/interaction-designer.svg', link: '#' },
            { title: 'Product Designer', iconPath: '/hire-us/product-designer.svg', link: '#' },
            { title: 'Web Designer', iconPath: '/hire-us/web-designer.svg', link: '#' },
        ],
    },
    {
        ...
        cardsData: [
            { title: 'Angular Developer', iconPath: '/hire-us/angular-developer.svg', link: '#' },
            { title: 'Nextjs Developer', iconPath: '/hire-us/nextjs-developer.svg', link: '#' },
            { title: 'Vuejs Developer', iconPath: '/hire-us/vuejs-developer.svg', link: '#' },
            { title: 'Nodejs Developer', iconPath: '/hire-us/nodejs-developer.svg', link: '#' },
            { title: 'Reactjs Developer', iconPath: '/hire-us/reactjs-developer.svg', link: '#' },
            { title: 'UI Developer', iconPath: '/hire-us/ui-developer.svg', link: '#' },
        ],
    },
]
