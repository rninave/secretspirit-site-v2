...
const timelineData = [
    ...
    { year: '2024', title: 'Strengthening Culture & Delivering Impact', description: 'In 2024, we continued to strengthen our team culture while delivering high-impact UI/UX and front-end solutions. With regular team outings, festival celebrations, and collaborative activities, we focused on building a balanced work environment that values both performance and people.', image: '/events/annual-outing-img1.jpeg' },
    { year: '2025', title: 'AI-Driven Evolution', description: 'In 2025, we embraced AI-powered design and development workflows to step into the future. We focused on intelligent, prompt-based design solutions and streamlined UI/UX processes. By exploring AI-assisted front-end development, we enhanced efficiency and creativity. This year marked our shift toward innovation-led, scalable, AI-driven digital experiences.', image: '/evolution/ai-dravin.png' },
]
