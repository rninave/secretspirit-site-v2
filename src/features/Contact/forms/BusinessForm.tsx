    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div>
                    <label className="block text-xs md:text-sm font-medium font-body text-body mb-2">Company name</label>
                    <input
                        name="company"
                        type="text"
            ...
            <div className="mt-5 md:mt-6 relative">
                <label className="block text-xs md:text-sm font-medium font-body text-body mb-2">Project description <span className="text-red-500">*</span></label>
                <textarea
                ...
                />
                <span className="absolute bottom-2 right-3 text-[10px] md:text-[12px] font-body text-body/60">
                    {charCount}/500
                </span>
            </div>
        </motion.div>
