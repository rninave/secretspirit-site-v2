        ...
        <div className="relative bg-white rounded-2xl border border-divider shadow-lg p-6 flex flex-col  h-full w-full">
            ...
            <div className="absolute top-0 left-6">
                <div className="px-2 py-4 rounded-b-full bg-gray-light shadow-btn">
                    <Image src="/icons/quotes-icon.svg" alt="Quote icon"  loading="eager" width={24} height={24} />
                </div>
            </div>
            {/* Testimonial text */}
            ...
            <div className="flex items-center justify-between mt-auto ">
                ...
                <Image src={item.clientLogo} alt={item.clientName + ' logo'} loading="eager" className="object-cover" width={100} height={100}  />
            </div>
        </div>
    );
}
